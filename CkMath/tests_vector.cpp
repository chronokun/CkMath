...
const bool Test_Vector_Projection()
{
	...
	const bool kbPass4d = math::Equal(math::Projection(TVector4d(), kA4d, kB4d), kC4d, s_kdEpsilon);
	const bool kbPass4f = math::Equal(math::Projection(TVector4f(), kA4f, kB4f), kC4f, s_kfEpsilon);
	const bool kbPass3d = math::Equal(math::Projection(TVector3d(), kA3d, kB3d), kC3d, s_kdEpsilon);
	const bool kbPass3f = math::Equal(math::Projection(TVector3f(), kA3f, kB3f), kC3f, s_kfEpsilon);
	const bool kbPass2d = math::Equal(math::Projection(TVector2d(), kA2d, kB2d), kC2d, s_kdEpsilon);
	const bool kbPass2f = math::Equal(math::Projection(TVector2f(), kA2f, kB2f), kC2f, s_kfEpsilon);
...
const bool Test_Vector_AngleBetween()
{
	...
	const bool kbPass4d = math::Equal(math::AngleBetween(kA4d, kB4d), s_kdTau / 4.0, s_kdEpsilon);
	const bool kbPass4f = math::Equal(math::AngleBetween(kA4f, kB4f), s_kfTau / 4.0f, s_kfEpsilon);
	const bool kbPass3d = math::Equal(math::AngleBetween(kA3d, kB3d), s_kdTau / 4.0, s_kdEpsilon);
	const bool kbPass3f = math::Equal(math::AngleBetween(kA3f, kB3f), s_kfTau / 4.0f, s_kfEpsilon);
	const bool kbPass2d = math::Equal(math::AngleBetween(kA2d, kB2d), s_kdTau / 4.0, s_kdEpsilon);
	const bool kbPass2f = math::Equal(math::AngleBetween(kA2f, kB2f), s_kfTau / 4.0f, s_kfEpsilon);
...
const bool Test_Vector_Distance()
{
	...
	const TVector2d kA2d{1.0, 0.0};
	const TVector2d kB2d{0.0, 1.0};
	const double kC2d = math::SquareRoot(2.0);

	const TVector2f kA2f{1.0f, 0.0f};
	const TVector2f kB2f{0.0f, 1.0f};
	const float kC2f = math::SquareRoot(2.0f);

	const bool kbPass4d = math::Equal(math::Distance(kA4d, kB4d), kC4d, s_kdEpsilon);
	const bool kbPass4f = math::Equal(math::Distance(kA4f, kB4f), kC4f, s_kfEpsilon);
	const bool kbPass3d = math::Equal(math::Distance(kA3d, kB3d), kC3d, s_kdEpsilon);
	const bool kbPass3f = math::Equal(math::Distance(kA3f, kB3f), kC3f, s_kfEpsilon);
	const bool kbPass2d = math::Equal(math::Distance(kA2d, kB2d), kC2d, s_kdEpsilon);
	const bool kbPass2f = math::Equal(math::Distance(kA2f, kB2f), kC2f, s_kfEpsilon);
